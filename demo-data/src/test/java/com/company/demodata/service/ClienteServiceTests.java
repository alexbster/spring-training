...
class ClienteServiceTests {
	...
	@Test
	@Order(12)
	void obtieneClientesExtrajerosConTarjetasInactivasDerivedMethod() {

		var clients = clienteService.obtieneClientesExtrajerosConTarjetasInactivasDerivedMethod("CR");
